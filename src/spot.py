...
"""Below are some sample use cases, details come soon"""       

#s = Spot("1295709267", clientid='abdd03cd5c1c4dc79d15cbf50b0641ad', clientsecret='REDACTED', redirect='https://example.com/callback/')
#s.my_playlists()
#sb = s.sb
...
# cafe = Playlist(user_id="1295709267", sb=s.sb, playlist_name="Stiches")
